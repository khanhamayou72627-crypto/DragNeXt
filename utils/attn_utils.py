...
class MutualSelfAttentionControl(AttentionBase):
    ...
    def __init__(self, start_step=4, 
                 start_layer=10, 
                 layer_idx=None, 
                 step_idx=None, 
                 total_steps=50, 
...
def override_attn_proc_forward(attn, 
                               editor, 
                               place_in_unet):
    def forward(x, 
...
def override_lora_attn_proc_forward(attn, 
                                    editor,
                                    place_in_unet):
...
def register_attention_editor_diffusers(model, 
