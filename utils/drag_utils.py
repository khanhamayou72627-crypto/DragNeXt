...
def calculate_l1_distance(tensor1: torch.Tensor, 
...
def get_neighboring_patch(tensor: torch.Tensor, 
                          center: tuple, 
...
def update_handle_points(handle_points: torch.Tensor, 
...
def point_tracking(F0: torch.Tensor, 
                   F1: torch.Tensor, 
                   handle_points: List[torch.Tensor],
                   handle_points_init: List[torch.Tensor], 
                   r2,
                   distance_type: str = 'l1') -> List[torch.Tensor]:
...
def interpolate_feature_patch(feat: torch.Tensor, 
                              y: float, 
                              x: float, 
                              r: int) -> torch.Tensor:
